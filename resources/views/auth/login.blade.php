        ...
        <div class="left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
            <div class="h-full w-full flex items-center justify-center">
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-[30px] w-[450px] shrink-0">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <input type="email" 
                                ...
                                placeholder="Write your email here" name="email" required autofocus autocomplete="username">
                        </div>
                                @if($errors->has('email'))
                    ...
                    <div class="flex flex-col gap-2">
                        <p class="font-semibold" :value="__('Password')">Password</p>
                        <div
                            class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                            <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            ...
                            <input type="password"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                                placeholder="Write your password here" name="password" required autocomplete="current-password">
                        </div>
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center w-full h-[52px] p-[14px_16px]">
