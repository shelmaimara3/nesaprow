                    ...
                    <div class="flex shrink-0 w-[120px] items-center">
                        <div class="relative h-[41px]">
                            <div class="menu-dropdown w-[120px] max-h-[41px] overflow-hidden absolute top-0 p-[10px_16px] bg-white flex flex-col gap-3 border border-[#EEEEEE] transition-all duration-300 hover:shadow-[0_10px_16px_0_#0A090B0D] rounded-[18px]">
                                ...
                                <a href="{{ route('dashboard.course.add_video', $course->id) }}" class="flex items-center justify-between font-bold text-sm w-full">
                                    Videos
                                </a>
                                <a href="{{ route('dashboard.course.add_modul', $course->id) }}" class="flex items-center justify-between font-bold text-sm w-full">
                                    Modul
                                </a>
                                <a href="{{ route('dashboard.course.course_students.create', $course) }}" class="flex items-center justify-between font-bold text-sm w-full">
                                    Students
                                </a>
