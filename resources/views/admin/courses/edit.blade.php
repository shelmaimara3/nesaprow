        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a href="{{ route('dashboard.courses.edit', $course) }}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold ">Update Course</a>
                </div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('dashboard.courses.update', $course) }}" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input value="{{ $course->name }}" type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" name="name" required>
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                    <p class="font-semibold">Path Trailer</p>
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="{{asset('images/icons/note-favorite-outline.svg')}}" class="w-full h-full object-contain" alt="icon">
                        </div>
                        <input type="text" value="{{ $course->path_trailer }}" id="path_trailer" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Link Video Referensi" name="path_trailer" :value="old('path_trailer')" required autofocus autocomplete="path_trailer">
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input type="textarea" value="{{ $course->about }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Deskripsi Materi" name="about" required>
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center gap-5">
                    <button type="submit" class="w-full h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Update Course</button>
                </div>
            </form>
