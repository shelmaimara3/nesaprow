...
@section('container')
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form method="POST" action="{{ route('dashboard.teachers.store') }}" id="add-teacher" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                <h2 class="font-bold text-2xl">Add New Teacher</h2>
