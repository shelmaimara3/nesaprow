        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col px-5 mt-5">
                <div class="w-full flex justify-between items-center">
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="font-extrabold text-[30px] leading-[45px]">{{ Auth::user()->hasRole('teacher') ? __('Teacher Dashboard') : __('Report Post Test') }}</p>
            ...
            <div class="flex flex-col gap-1 mt-3 mb-auto">
                ...
                <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                    <div class="course-list-header flex flex-nowrap justify-between pb-4 pr-10 border-b border-[#EEEEEE]">
                        <div class="flex shrink-0 w-[150px]">
                            <p class="text-[#7F8190]">Soal Kognitif</p>
                        </div>
                    ...
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        <div class="flex shrink-0 w-[170px]">
                            <div class="flex items-center gap-4">
