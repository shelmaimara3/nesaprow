        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    <a href="{{ route('dashboard.video') }}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Home</a>
                    ...
                    <div class="flex flex-col rounded-t-[12px] rounded-b-[24px] gap-[32px] bg-[#f5f3f2] w-full pb-[10px] overflow-hidden transition-all duration-300 hover:ring-2 hover:ring-[#6436F1]">
                        ...
                        <div class="flex flex-col px-4 gap-[10px]">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('dashboard.details.video', $course->slug) }}" class="w-fit p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center align-middle">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
